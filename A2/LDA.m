...
%
%
% Last modified by original authors: Dec-11-2010
% Last modified by Alessandro "Ollie" D'Amico: Feb-05-2020 
...
% Ollie edit -- Shrinkage
s = 0.03;
v = trace(PooledCov) / size(PooledCov, 2);
PooledCov = ((1-s)*PooledCov) + (s*v*eye(size(PooledCov, 2)));
